...
<%
    ...
    if (preload)
    {
        ...
        if (isReviews) {
            styles.Add("/css/default/reviews.css");
        }
        ...
        if (isReferAFriend) {
            styles.Add("/css/default/referafriend.css");
        }

        if (isUpsell) {
            styles.Add("/css/default/upsell.css");
        }
        ...
        if (isProcessPayment) {
            styles.Add("/css/default/processpayment.css");
        }
